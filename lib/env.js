...
module.exports = function env(options) {
  var ctx = {
    ...
    request: {
      ...
      ip:         (options.http || options.rpc).req.connection.remoteAddress,
  ...
  ctx.helpers.runtime_json = function () {
    this.runtime.locale = this.runtime.locale || nodeca.config.locales['default'];
    return JSON.stringify(this.runtime);
  }.bind(ctx);
