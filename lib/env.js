...
module.exports = function env(options) {
  ...
  //
  // env-dependent env-methods
  //

  ctx.permissions_param = function (key, val) {
    this.permissions.params[key] = val;
  };

  ctx.permissions_cache = function (store, params, data) {
    nodeca.permissions.cache(this, store, params, data);
  };

  ctx.permission = function (key) {
    var val = this.permissions.values[key];
  ...
  ctx.helpers.permission = function (key) {
    var val = this.response.data.permissions[key];
