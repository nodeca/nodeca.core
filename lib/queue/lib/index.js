  ...
  self.__redis__.multi()
    ...
    self.__redis__.eval(
      ...
      function (err, updated) {
        ...
        var task = new Task(taskID, JSON.parse(taskData), worker);
  ...
  self.__redis__.multi()
    ...
    self.__redis__.eval(
      ...
      function (err, moved) {
        ...
        var task = new Task(taskID, null, worker);
...
Queue.prototype.__tick__ = function () {
  ...
  self.__redis__.time(function (err, time) {
    ...
    var setName = self.__prefix__ + 'mapping';

    // Get tasks IDs and its deadlines
    self.__redis__.zrangebyscore(setName, '-inf', redisToMs(time), 'withscores', function (err, result) {
      if (err) {
        self.emit('error', err);
        return;
      }
  ...
  self.__redis__.time(function (err, time) {
    ...
    var setName = self.__prefix__ + 'reducing';
