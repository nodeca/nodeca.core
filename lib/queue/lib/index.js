...
Queue.prototype.cancel = function (workerName, taskID, callback) {
  ...
  // If taskID not defined - cancel all tasks for this worker
  if (!taskID) {
    this.__getTasks__(workerName, function (err, IDs) {
      if (err) {
        callback(err);
        return;
      }
...
// - workerName (String)
//
Queue.prototype.__getTasks__ = function (workerName, callback) {
  var self = this;
