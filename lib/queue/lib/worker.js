...
//
Worker.prototype.postpone = Promise.coroutine(function* (taskData, delay) {
...
//
Worker.prototype.status = Promise.coroutine(function* (taskID) {
  let result = {};
...
Worker.prototype.cancel = function (taskID) {
  // Default to taskID() for singleton workers
