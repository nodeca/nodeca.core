...
var toPromiseFn = require('./utils').toPromiseFn;
...
//
Worker.prototype.push = thenify.withCallback(function (taskData, callback) {
  if (!callback) {
    callback = taskData;
    taskData = null;
  }
...
// - callback (Function) - called as: `function (err)`
//
Worker.prototype.postpone = thenify.withCallback(function (taskData, delay, callback) {
  var self = this;
...
//
Worker.prototype.status = thenify.withCallback(function (taskID, callback) {
  var self = this;
...
// - callback (Function) - called as: `function (err)`
//
Worker.prototype.cancel = thenify.withCallback(function (taskID, callback) {
  if (!callback) {
    callback = taskID;
    taskID = this.taskID();
  }
