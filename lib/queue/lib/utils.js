...
module.exports.promiseOrCallback = function (promise, callback) {
  if (!callback) return promise;

  promise.then(
    result => process.nextTick(callback.bind(null, null, result)),
    err => process.nextTick(callback.bind(null, err))
  );
};
