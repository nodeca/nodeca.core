...
module.exports = function (N) {
  N.wire.once('init:parser', function attachment_plugin_init() {
    const plugin = require('nodeca.core/lib/parser/plugins/attachment')(N, {
    ...
    N.parser.addPlugin(
      'attachment',
      function (parser) {
        parser.bus.on('ast2html', function* fetch_attachment_data(data) {
          ...
          yield N.wire.emit('internal:common.content.attachments', attach_list);
