...
module.exports = function (N) {
  ...
  let serverSecretKey = createToken();
  // Faye instance
  let fayeNodeAdapter = null;
  // Unique instance ID to allow send message for clients of specific
  // server instance (used in `common.core.server_restart`)
  let serverInstanceId = createToken();
