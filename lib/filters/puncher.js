...
//
nodeca.filters.before('', { weight: -9000 }, function start_puncher(params, callback) {
...
function inject_stats(env) {
  ...
  resp.body = resp.body.replace(
    '<!--{{PUNCHER_STATS}}-->',
    nodeca.shared.common.render(viewsTree, 'common.widgets.debug_timeline', false, resp.data));
}
