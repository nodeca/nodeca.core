 ...
 **/
Settings.prototype.get = co.wrap(function* get(keys, params, options) {
  let results     = {};
  ...
  (yield Object.keys(store_keys).map(name => this.getStore(name).get(store_keys[name], params, options)))
    .forEach(data => {
