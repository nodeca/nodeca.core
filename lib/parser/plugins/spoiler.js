...
module.exports = function () {
  ...
  return function (parser) {
    ...
    parser.bus.on('md2html.render', function render_spoiler(data) {
    ...
    //
    parser.bus.before('html2preview.render', function replace_spoiler(data) {
      data.ast.find('.spoiler').each(function () {
        let $content = $(this).find('.spoiler__content');
