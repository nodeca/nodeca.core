...
module.exports = function (N) {
  ...
  return function (parser) {
    ...
    // Links to HTML
    //
    const intTpl = _.template('<a href="<%- href %>" class="link link-int<%- auto ? " link-auto" : "" %>"' +
                              ' title="<%- title %>"></a>');
    const extTpl = _.template('<a href="<%- href %>" class="link link-ext<%- auto ? " link-auto" : "" %>"' +
                              ' title="<%- title %>" target="_blank" rel="nofollow noopener"></a>');
