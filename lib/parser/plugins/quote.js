...
module.exports = function (N) {
  ...
  return function (parser) {
    ...
    parser.bus.after('md2html.render', function render_quote(data) {
    ...
    parser.bus.after('md2html.render', function quote_replace_contents(data) {
    ...
    // Remove blockquote
    //
    parser.bus.before('html2preview.render', function remove_blockquote(data) {
      data.ast.find('blockquote').remove();
    });
  };
};
