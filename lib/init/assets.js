...
module.exports = function (next) {
  ...
  files       = ['lib.js', 'app.js', 'app.css', 'modernizr.custom.js'];
  ...
  Mincer.StylusEngine.registerConfigurator(function (style) {
    style.use(nib());
    style.define('import_tree', require('../stylus/import-tree'));
  });
  ...
  // Usage: SKIP_ASSETS_COMPRESS=1 ./nodeca.js server
  if (!process.env.SKIP_ASSETS_COMPRESS) {
