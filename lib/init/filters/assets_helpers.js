...
Extras.prototype = {
  ...
  __precompile__: function (callback) {
    if (0 === this.__data__.precompile.length) {
      callback(null);
      return;
    }

    nodeca.runtime.assets.environment.precompile(this.__data__.precompile, callback);
  }
};
...
nodeca.filters.after('', {weight: 50}, function precompile_required_assets(params, callback) {
  this.extras.assets.__precompile__(callback);
});
