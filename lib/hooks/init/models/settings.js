...
module.exports = function (N) {
  ...
  //     validators: null
  //
  N.wire.before('init:settings', { priority: -1 }, function normalize_setting_schemas(sandbox) {
  ...
  //
  N.wire.before('init:settings', { priority: -1 }, function resolve_schema_defaults(sandbox, callback) {
    var resolvers = [];
