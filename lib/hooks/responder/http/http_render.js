...
module.exports = function (N) {
  ...
  N.wire.after('responder:http', { priority: 10 }, function http_render(env) {
    ...
    var apiPath = env.response.apiPath || env.method
    ...
    helpers.getApiPath = function getApiPath() {
      return apiPath;
    };

    helpers.setLayout = function setLayout(layout) {
      env.response.layout = layout;
    };
