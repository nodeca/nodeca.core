...
// internal
var render  = require('./render/server');
...
module.exports = function env(options) {
  ...
  var ctx = {
    ...
    runtime: {
      ...
      // TODO:  should be set at least to default state once theming supported
      theme: null
    },
    settings: {
      params: {},
  ...
  ctx.helpers.render = function (apiPath, locals, layout) {
    return render(apiPath, locals, layout, this);
  }.bind(ctx);
