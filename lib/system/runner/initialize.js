...
function initScope(N) {
  ...
  // patch revalidator to add 'mongo' format shortcut
  revalidator.validate.formats.mongo = /^[0-9a-fA-F]{24}$/;
...
module.exports = function (N) {
  ...
  //
  // Create `N.config.version_hash` - unique value, that tracks packages
