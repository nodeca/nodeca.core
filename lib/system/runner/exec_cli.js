...
module.exports = function (N, callback) {
  ...
  _.forEach(N.apps, function (app) {
    ...
    fstools.walkSync(cliRoot, /\.js$/, function (file) {
      ...
      _.forEach(cli.commandLineArguments || [], function (item) {
        subArgparser.addArgument(item.args, item.options);
      });
  ...
  if (0 === N.args.length && commands.server) {
