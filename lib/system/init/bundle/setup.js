...
module.exports = function (sandbox) {
  ...
  bundler.registerHelper('asset_url', function asset_url(path) {
  ...
  // Setup defaults for `browserify.no_parse` and `browserify.no_babelify`
  sandbox.browserify = { no_parse: [], no_babelify: [] };
};
