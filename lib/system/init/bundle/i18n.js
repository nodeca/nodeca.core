...
module.exports = function (sandbox, callback) {
  ...
  // Expose variables to plugins
  sandbox.i18n = {
    serverI18n:    serverI18n,
    clientI18n:    clientI18n,
    addClientI18n: addClientI18n,
    addServerI18n: addServerI18n
  };

  //
  // Call plugins & build files on the end
  //

  N.wire.emit('init:bundle.i18n.phrases', sandbox, function (err) {
    if (err) {
      callback(err);
      return;
    }
