...
const no_parse   = require('./browserify_no_parse');
const no_babel   = require('./browserify_no_babelify');
...
module.exports = function (sandbox, callback) {
  ...
  function browserify_concat_plugin(context, cb) {
    ...
    b.transform(cacheify(babelify.configure({ ignore: no_babel }), sandbox.cache_db), { presets: [ 'es2015' ] });
