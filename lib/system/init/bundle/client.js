...
// Check if there is any existent and bundled module by client module identifier
// (absolute path or an alias name).
function hasBundledModule(sandbox, modulePath) {
...
function browserify(sandbox, files, destination) {
  ...
  _.each(files, function (pathname) {
    ...
    findRequires(source).forEach(function (modulePath) {
      ...
      if (!hasBundledModule(modulePath)) {
