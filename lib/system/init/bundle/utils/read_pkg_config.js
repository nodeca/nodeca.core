...
// ```
// vendor:
//   "": [ "/absolute/path/to/foo.js", "/absolute/path/to/bar.js" ]
//   "bar_alias": "/absolute/path/to/bar.js"
// ```
//
function normalizeVendor(app, config) {
  ...
  _.forEach(config, function (vendorPkg) {
    var filename, alias, resolvedPath;
    ...
    if (alias && fs.statSync(resolvedPath).isDirectory()) {
      return; // It is a directory alias - do not add to files list.
    }
